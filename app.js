...
function renderDashboard(){
  ...
  STATUS_ORDER.forEach(status => {
    ...
    html += `<div class="dash-group"><div class="dash-group-header">${esc(status)}<span class="dash-badge ${STATUS_CSS[status]||''}">${items.length}</span></div><div class="dash-group-body">`;
    items.forEach(p => {
