...
window.T1 = window.T1 || {};
window.T1.assetVersion = '20260924';
...
// ACCESS MANAGEMENT 區塊已移除（2026-08）——renderAccessMgmt/accessMgmtSave 保留以防既有資料處理需要
